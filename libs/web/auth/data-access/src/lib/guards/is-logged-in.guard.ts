...
import { WebAuthStore } from '../web-auth.store'

@Injectable()
export class IsLoggedInGuard implements CanActivate, CanActivateChild, CanLoad {
  constructor(private readonly authStore: WebAuthStore, private readonly router: Router) {}
  ...
  private isAuthenticated(url?: string): Observable<boolean | UrlTree> {
    return this.authStore.loggedIn$.pipe(
